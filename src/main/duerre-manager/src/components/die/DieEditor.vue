<template>
    <div class="w-100 h-100" style="position: relative;">
        ...
        <v-toolbar border density="compact" style="position: relative;">
            <template v-slot:prepend>
                <v-btn icon="mdi-arrow-left"></v-btn>
            </template>

            <v-btn icon="mdi-chart-line-variant" :color="lineToolColor" @click="useDrawLineTool">
            </v-btn>
            <v-btn icon="mdi-gesture" @click="useDrawCurveTool">
            </v-btn>
            <v-divider class="mx-3 align-self-center" length="24" thickness="2" vertical></v-divider>
            <v-btn icon="mdi-eraser" @click="useEraserTool">
            </v-btn>
            <v-btn icon="mdi-ray-start-vertex-end" @click="useEditTool">
            </v-btn>
            <v-btn icon="mdi-cursor-move" @click="useMoveTool">
            </v-btn>
            <v-divider class="mx-3 align-self-center" length="24" thickness="2" vertical></v-divider>
            ...
            <v-divider class="mx-3 align-self-center" length="24" thickness="2" vertical></v-divider>
            <v-btn icon="mdi-undo" @click="undo">
            </v-btn>
            <v-btn icon="mdi-content-save-outline"></v-btn>
            <v-btn icon="mdi-redo" @click="redo">
            </v-btn>
