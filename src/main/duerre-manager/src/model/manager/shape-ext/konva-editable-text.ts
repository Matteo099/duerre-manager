...
export class KonvaEditableText {
    ...
    public static onEdit: Subject<boolean> = new Subject<boolean>();
    static {
    ...
    constructor(editor: IDieEditor, opts: Konva.TextConfig = {
        x: 0,
        y: 0,
        text: "0 mm",
        fill: '#333',
    ...
    private handleDoubleTap(event: Konva.KonvaEventObject<any>) {
        ...
        KonvaEditableText.onEdit.next(true);
    ...
    private removeTextarea(save: boolean) {
        ...
        KonvaEditableText.onEdit.next(false);
